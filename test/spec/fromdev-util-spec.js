    ...
    describe('1. Test Amazon Util Behavior', function () {
        ...
        describe('Test Append Affiliate Tag Scenarios', function () {
            it('Append Affiliate tag to Amazon URL', function () {
                ...
                expect(AmazonUtils.addAffiliateTag('https://www.amazon.com/MintBox-IPC-D2x2-C3337NL-H500-WB-XLM-FM4U-BMint-2-Desktop/dp/B00EONR674/')).toEqual('https://www.amazon.com/MintBox-IPC-D2x2-C3337NL-H500-WB-XLM-FM4U-BMint-2-Desktop/dp/B00EONR674/' + '?tag=fromdevtools-20');
                expect(AmazonUtils.addAffiliateTag('https://www.amazon.com/CompuLab-fit-Headless-Display-Emulator/dp/B00FLZXGJ6/ref=pd_sim_147_3?_encoding=UTF8&psc=1&refRID=6B8NRRYW1V0VH98QZV6J')).toEqual('https://www.amazon.com/CompuLab-fit-Headless-Display-Emulator/dp/B00FLZXGJ6' + '?tag=fromdevtools-20' + '&_encoding=UTF8&psc=1&refRID=6B8NRRYW1V0VH98QZV6J');
                expect(AmazonUtils.addAffiliateTag('https://www.amazon.com/dp/B01LWW2CGN?psc=1')).toEqual('https://www.amazon.com/dp/B01LWW2CGN' + '?tag=fromdevtools-20&psc=1');
